  ...
  return (
    <form onSubmit={handleSubmit} className="dark:bg-zinc-900 bg-white p-6 sm:p-8 rounded-xl shadow-lg border dark:border-purple-900/50 border-purple-200 mb-8 relative">
      ...
      <div className="absolute inset-0 overflow-hidden rounded-xl pointer-events-none">
        <div className="absolute top-0 right-0 w-64 h-64 bg-purple-900/20 rounded-full blur-3xl -mr-10 -mt-10"></div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-6 relative z-50">
        ...
        <div className="md:col-span-4">
          ...
          <input 
            ...
            className="w-full border dark:border-zinc-700 border-gray-300 p-3 rounded dark:bg-zinc-800 bg-gray-50 dark:text-white text-black focus:outline-none focus:border-purple-500 transition-colors relative z-50" 
        ...
        <div className="md:col-span-2">
          ...
          <select value={difficulty} onChange={(e) => setDifficulty(e.target.value)} className="w-full border dark:border-zinc-700 border-gray-300 p-3 rounded dark:bg-zinc-800 bg-gray-50 dark:text-white text-black focus:outline-none focus:border-purple-500 transition-colors relative z-50">
        ...
        <div className="md:col-span-2">
          ...
          <select value={priority} onChange={(e) => setPriority(e.target.value)} className="w-full border dark:border-zinc-700 border-gray-300 p-3 rounded dark:bg-zinc-800 bg-gray-50 dark:text-white text-black focus:outline-none focus:border-purple-500 transition-colors relative z-50">
