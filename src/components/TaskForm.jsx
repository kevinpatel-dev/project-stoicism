      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-10">
          ...
          <div className="md:col-span-5">
            <label className="block text-[10px] font-black dark:text-zinc-500 text-gray-400 uppercase mb-3 ml-1 tracking-widest">Quest Description</label>
            <input 
          ...
          <div className="md:col-span-2">
            ...
            <select 
              ...
              className="w-full border dark:border-zinc-800 border-gray-200 p-5 rounded-2xl dark:bg-zinc-950 bg-gray-50 dark:text-white text-zinc-900 outline-none focus:ring-4 focus:ring-purple-500/10 font-bold text-lg appearance-none cursor-pointer"
            >
        ...
        <button 
          type="submit" 
          className="group w-full bg-purple-600 hover:bg-purple-700 text-white py-5 rounded-[1.5rem] font-black text-sm tracking-[0.2em] transition-all shadow-2xl shadow-purple-500/30 flex items-center justify-center gap-6 active:scale-[0.98]"
        >
